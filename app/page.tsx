...
// ── Landing copy ──────────────────────────────────────────────────────────
// Site-specific strings. The chapter grid, stats, and marquee fill themselves
// in from `content/`.
const WORDMARK = "Fuel Lab";
const HERO_EYEBROW = "Evidence-based sports nutrition";
const HERO_TAGLINE =
  "Protein, carbs, supplements and body composition — what the research actually says, minus the bro-science. Built for athletes who want numbers, not vibes.";
const CTA_LABEL = "Start the course";
const FOOTER_NOTE = "Fuel Lab — nutritional science for athletes.";

// ── More courses ──────────────────────────────────────────────────────────
// Manually curated links to the other course sites in this family. Update the
// list on every site's landing page when a new course ships.
const OTHER_COURSES = [
  {
    title: "Rökland",
  ...
  return (
    <main className="relative flex flex-1 flex-col overflow-hidden">
      ...
      <div aria-hidden className="pointer-events-none absolute inset-0 -z-10">
        ...
        <BookOpen className="absolute -right-24 top-24 icon-96 rotate-12 text-brand/[0.07]" />
      </div>
      ...
      <section className="mx-auto flex w-full max-w-6xl flex-col items-center px-6 pb-20 pt-16 text-center md:px-10 md:pt-24">
        ...
        >
          Fuel the work. <span className="text-brand">Feed</span> the results.
        </h1>
        <p
